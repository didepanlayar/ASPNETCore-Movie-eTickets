    ...
    public class AppDbInitializer
    {
            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Cinemas.Any())
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                    {
                        ...
                        new Cinema()
                        {
                            ...
                            Description = "This is the Description of the Cinema 5."
                        }
                    });
                    context.SaveChanges();
                }
                ...
                if (!context.Actors.Any())
                {
                    context.Actors.AddRange(new List<Actor>()
                    {
                        ...
                        {
                            FullName = "Actor 1",
                            Bio = "This is the Bio of the Actor 1",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-1.jpeg"
                        },
                        new Actor()
                        {
                            FullName = "Actor 2",
                            Bio = "This is the Bio of the Actor 2",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-2.jpeg"
                        },
                        new Actor()
                        {
                            FullName = "Actor 3",
                            Bio = "This is the Bio of the Actor 3",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-3.jpeg"
                        },
                        new Actor()
                        {
                            FullName = "Actor 4",
                            Bio = "This is the Bio of the Actor 4",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-4.jpeg"
                        },
                        new Actor()
                        {
                            FullName = "Actor 5",
                            Bio = "This is the Bio of the Actor 5",
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                string administratorUserEmail = "administrator@etickets.com";
                var administratorUser = await userManager.FindByEmailAsync(administratorUserEmail);
                if(administratorUser == null)
                {
                    var newAdministratorUser = new ApplicationUser()
                    {
                    ...
                    await userManager.CreateAsync(newAdministratorUser, "Coding12345!");
                    await userManager.AddToRoleAsync(newAdministratorUser, UserRoles.Administrator);
                }
